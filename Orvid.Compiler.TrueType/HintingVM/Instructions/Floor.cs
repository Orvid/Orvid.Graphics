...
{
	public class Floor : IRInstruction
	{

		public override IROpCode OpCode
		{
			get { return IROpCode.Floor; }
		}
		...
		public override void Emit(IRMethodBuilder IRbldr, ILGenerator gen, MethodBuilder mBldr, TypeBuilder tBldr, bool isGlyph)
		{
			...
			gen.Emit(OpCodes.Call, F26Dot6_Floor);
		...
		{
			IRbldr.TWriteLine(tOut, "Floor[]" + GetArgString(1, true));
			IRbldr.curInstructionLength = ("Floor[]" + GetArgString(1, true)).Length;
		}
