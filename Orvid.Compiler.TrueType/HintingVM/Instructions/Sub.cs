...
{
	public class Sub : IRInstruction
	{
		...
		public override void Emit(IRMethodBuilder IRbldr, ILGenerator gen, MethodBuilder mBldr, TypeBuilder tBldr, bool isGlyph)
		{
			...
			gen.Emit(OpCodes.Call, F26Dot6_Subtract);
		...
		{
			IRbldr.TWriteLine(tOut, "Sub[]" + GetArgString(2, true));
			IRbldr.curInstructionLength = ("Sub[]" + GetArgString(2, true)).Length;
		}
