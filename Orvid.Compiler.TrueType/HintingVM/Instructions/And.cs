...
{
	public class And : IRInstruction
	{

		public override IROpCode OpCode
		{
			get { return IROpCode.And; }
		}
		...
		{
			IRbldr.TWriteLine(tOut, "And[]" + GetArgString(2, true));
			IRbldr.curInstructionLength = ("And[]" + GetArgString(2, true)).Length;
		}
	}
}
