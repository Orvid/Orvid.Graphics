...
{
	public class Abs : IRInstruction
	{
		public override IROpCode OpCode
		{
			get { return IROpCode.Abs; }
		}
		...
		public override void Emit(IRMethodBuilder IRbldr, ILGenerator gen, MethodBuilder mBldr, TypeBuilder tBldr, bool isGlyph)
		{
			...
			gen.Emit(OpCodes.Call, F26Dot6_Abs);
		...
		{
			IRbldr.TWriteLine(tOut, "Abs[]" + GetArgString(1, true));
			IRbldr.curInstructionLength = ("Abs[]" + GetArgString(1, true)).Length;
		}
