...
{
	public class Neg : IRInstruction
	{

		public override IROpCode OpCode
		{
			get { return IROpCode.Neg; }
		}
		...
		public override void Emit(IRMethodBuilder IRbldr, ILGenerator gen, MethodBuilder mBldr, TypeBuilder tBldr, bool isGlyph)
		{
			...
			gen.Emit(OpCodes.Call, F26Dot6_Negate);
		...
		{
			IRbldr.TWriteLine(tOut, "Neg[]" + GetArgString(1, true));
			IRbldr.curInstructionLength = ("Neg[]" + GetArgString(1, true)).Length;
		}
