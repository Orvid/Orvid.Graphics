...
namespace OForms.Controls
{
    ...
    public abstract class Control : IDisposable
    {
		...
		/// <summary>
		/// This event occurs when the control
		/// is moved.
		/// </summary>
		public event EventHandler Move;
		/// <summary>
		/// This event occurs when the control's
		...
		/// <summary>
		/// The dummy EventHandler.
		/// </summary>
		private void DummyEventHandler(object sndr, EventArgs args) { }
        /// <summary>
		...
		/// </summary>
		internal void DoMove() { Move.Invoke(null, new EventArgs()); }
		/// <summary>
		/// Invokes the SizeChanged event.
		/// </summary>
		internal void DoSizeChanged() { SizeChanged.Invoke(null, new EventArgs()); }
		/// <summary>
		/// Invokes the TextChanged event.
		/// </summary>
		internal void DoTextChanged() { TextChanged.Invoke(null, new EventArgs()); }
        #endregion
        ...
        {
            get { return iIsMouseDown; }
            set { iIsMouseDown = value; }
        }

		private string local_Text = String.Empty;
		/// <summary>
		...
		public string Text
		{
			get { return local_Text; }
			set { local_Text = value; }
		}
        ...
        public Control(Vec2 loc, Vec2 size)
		{
			...
			this.Move = new EventHandler(DummyEventHandler);
			this.SizeChanged = new EventHandler(DummyEventHandler);
			this.TextChanged = new EventHandler(DummyEventHandler);
            this.X = loc.X;
            this.Y = loc.Y;
            this.Size = size;
