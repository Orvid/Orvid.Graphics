...
namespace Hqx
{
    ...
    public static class HqxSharp
    {
		...
		public static unsafe Bitmap Scale2(Bitmap b)
		{
			return Scale2(b, 48, 7, 6, 0, false, false);
		}
        ...
        /// <returns>A new Bitmap instance that contains the source imagage scaled to twice its size.</returns>
        public static unsafe Bitmap Scale2(Bitmap bitmap, uint trY, uint trU, uint trV, uint trA, bool wrapX, bool wrapY)
        {
		...
		public static unsafe void Scale2(uint* sp, uint* dp, int Xres, int Yres)
		{
			Scale2(sp, dp, Xres, Yres, 48, 7, 6, 0, false, false);
		}
        ...
        /// <param name="wrapX">Used for images that can be seamlessly repeated horizontally.</param>
        /// <param name="wrapY">Used for images that can be seamlessly repeated vertically.</param>
        public static unsafe void Scale2(uint* sp, uint* dp, int Xres, int Yres, uint trY, uint trU, uint trV, uint trA, bool wrapX, bool wrapY)
        {
		...
		public static unsafe Bitmap Scale3(Bitmap b)
		{
			Scale3(b, 48, 7, 6, 0, false, false);
		}
        ...
        /// <param name="wrapY">Used for images that can be seamlessly repeated vertically.</param>
        /// <returns>A new Bitmap instance that contains the source imagage scaled to three times its size.</returns>
        public static unsafe Bitmap Scale3(Bitmap bitmap, uint trY, uint trU, uint trV, uint trA, bool wrapX, bool wrapY)
        {
        ...
        /// <param name="Xres">The horizontal resolution of the source image.</param>
        /// <param name="Yres">The vertical resolution of the source image.</param>
		public static unsafe void Scale3(uint* sp, uint* dp, int Xres, int Yres)
		{
		...
		{
			return Scale4(bitmap, 48, 7, 6, 0, false, false);
		}
        ...
        /// <param name="wrapY">Used for images that can be seamlessly repeated vertically.</param>
        /// <returns>A new Bitmap instance that contains the source imagage scaled to four times its size.</returns>
        public static unsafe Bitmap Scale4(Bitmap bitmap, uint trY, uint trU, uint trV, uint trA, bool wrapX, bool wrapY)
        {
        ...
        /// <param name="Xres">The horizontal resolution of the source image.</param>
        /// <param name="Yres">The vertical resolution of the source image.</param>
		public static unsafe void Scale4(uint* sp, uint* dp, int Xres, int Yres)
		{
