...
namespace Orvid.Graphics.ImageFormats
{
    public class PngImage : ImageFormat
    {
        ...
        private class PngEncoder
        {
            ...
            /// </value>
            public bool IsWritingUncompressed
			{
				get { return local_IsWritingUncompressed; }
				set { local_IsWritingUncompressed = value; }
			}
			private bool local_IsWritingUncompressed;
            ...
            /// </value>
            public bool IsWritingGamma 
			{
				get { return local_IsWritingGamma; }
				set { local_IsWritingGamma = value; }
			}
			private bool local_IsWritingGamma;
            ...
            public double Gamma 
			{
				get { return local_Gamma; }
				set { local_Gamma = value; }
			}
			private double local_Gamma;
...
#warning TODO: Un-Comment this when DPI is supported in Orvid.Graphics.Image
            ...
            static PngDecoder()
            {
                ...
                _colorTypes.Add(0,
                    new PngColorTypeInformation(1, new int[] { 1, 2, 4, 8 }, 
                        delegate(byte[] p, byte[] a)
						{
							return new GrayscaleReader(false);
						}));
                ...
                _colorTypes.Add(2,
                    new PngColorTypeInformation(3, new int[] { 8 },
                        delegate(byte[] p, byte[] a)
						{
							return new TrueColorReader(false);
						}));
                ...
                _colorTypes.Add(3,
                    new PngColorTypeInformation(1, new int[] { 1, 2, 4, 8 },
                        delegate(byte[] p, byte[] a)
						{
							return new PaletteIndexReader(p, a);
						}));
                ...
                _colorTypes.Add(4,
                    new PngColorTypeInformation(2, new int[] { 8 },
                        delegate(byte[] p, byte[] a)
						{
							return new GrayscaleReader(true);
						}));
				...
				_colorTypes.Add(6,
					new PngColorTypeInformation(4, new int[] { 8 },
						delegate(byte[] p, byte[] a)
						{
							return new TrueColorReader(true);
						}));
            }
		...
		public class Func<T, T2, TResult>
		{
        ...
        private sealed class PngColorTypeInformation
        {
            ...
            public int[] SupportedBitDepths 
			{
				get { return local_SupportedBitDepths; }
				private set { local_SupportedBitDepths = value; }
			}
			private int[] local_SupportedBitDepths;

			public delegate ColorReader ScanlineReaderDelegate(byte[] a, byte[] b);
			...
			public ScanlineReaderDelegate ScanlineReaderFactory 
			{
				get { return local_ScanlineReaderFactory; }
				private set { local_ScanlineReaderFactory = value; }
			}
			private ScanlineReaderDelegate local_ScanlineReaderFactory;

            /// <summary>
            /// Gets a factor that is used when iterating through the scanlines.
            /// </summary>
            /// <value>The scanline factor.</value>
            public int ChannelsPerColor 
			{
				get { return local_ChannelsPerColor; }
				private set { local_ChannelsPerColor = value; }
			}
			private int local_ChannelsPerColor;
			...
			public PngColorTypeInformation(int scanlineFactor, int[] supportedBitDepths, ScanlineReaderDelegate scanlineReaderFactory)
            {
